...
```bash
PYTHONPATH=src python -m aether_core.cli validate visual-asset-candidate --json <candidate-batch.json>
```
...
```bash
PYTHONPATH=src python -m aether_core.cli visual-asset list --type <type> --status active --summary
...
```bash
PYTHONPATH=src python -m aether_core.cli visual-asset branch <parent-asset-id> --json <visual-asset.json>
PYTHONPATH=src python -m aether_core.cli visual-asset merge <source-asset-id> <target-asset-id>
PYTHONPATH=src python -m aether_core.cli visual-asset activate <visual-asset-id>
```
